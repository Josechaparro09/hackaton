				...
				<header className="mb-4 sm:mb-8 animate-fade-in">
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-2">
						<div className="flex items-center gap-2 sm:gap-3">
							<div className="p-2 sm:p-3 rounded-xl gradient-primary">
							...
							<div>
								...
								<p className="text-xs sm:text-sm text-muted-foreground">Predicción de Consumo Energético</p>
							</div>
						</div>
						<div className="flex items-center gap-2 w-full sm:w-auto">
							...
							<Link to="/solar-production" className="flex-1 sm:flex-initial">
								<Button variant="outline" className="gap-2 w-full sm:w-auto text-xs sm:text-sm">
									<Sun className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
									<span className="hidden sm:inline">Producción Solar</span>
